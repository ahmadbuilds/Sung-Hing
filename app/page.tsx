...
export default function Home() {
  return (
    <div>
      ...
      <div className="w-full h-[75vh] relative overflow-hidden">
        <Carousel className="w-full h-full relative">
          <CarouselContent className="w-full h-full ml-0 cursor-pointer hover:text-red-500">
            <CarouselItem className="relative w-full h-[75vh] pl-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center w-full h-[75vh] z-30 text-white">
                <div className="bg-red-500/15 p-20 w-full">
                  <CarouselPrevious  className="absolute top-1/2 left-[12px] md:left-[45px] -translate-y-1/2 z-10"/>
                  <div className="">
                    <h1 className="text-3xl md:text-6xl lg:text-8xl font-extrabold">Introducing <br></br>MarketPlace</h1>
                    <p className="text-xs pt-5 md:p-10 ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                    Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s.</p>
                  </div>
                  <CarouselNext  className="absolute top-1/2 right-[12px] md:right-[45px] -translate-y-1/2 z-10 cursor-pointer hover:text-red-500"/>
                </div>
              </div>
            </CarouselItem>
          </CarouselContent>
      ...
      {/* Fresh Roots Page */}
      <div className="w-full md:max-w-[calc(100vw-45px)] mb-10 mx-auto h-auto xl:h-[75hv] relative p-4 sm:p-6 xl:p-10">
        ...
        <div className="relative flex-shrink-0">
          ...
          <div className="hidden xl:flex absolute top-0 right-[-60%] z-10 w-full bg-white justify-between p-6 rounded-bl-3xl gap-4 items-center">
            ...
            <Image src={'/logo.webp'} alt="Logo image" width={120} height={120}/>
          </div>
        </div>
      ...
      <div className="w-full relative overflow-hidden">
        ...
        <div className=" top-0 left-0 absolute flex flex-col justify-center p-6  text-center lg:px-10  items-center gap-3 w-full h-full ">
            ...
            <h1 className="font-bold text-blue-400 text-5xl  xl:mt-0 mt-20 xl:text-7xl">Our Future</h1>
        </div>
        ...
        <div className="w-full flex absolute bottom-0 left-0 z-10">
          <Image 
            ...
            height={560} 
            priority 
            className="-scale-x-100 object-cover w-1/2 h-auto"
          />
          <Image 
            src={'/grass.webp'} 
            alt="Grass Image"  
      ...
      <div className="w-full relative overflow-hidden">
        ...
        <div className="bottom-0 h-full md:left-10  left-[-60px] absolute z-40 flex items-end ">
        ...
        <div className="hidden absolute h-full -bottom-24 -left-28 z-30 xl:flex lg:items-end">
            <Image src={'/logo.webp'} alt="Logo Picture" width={850} height={850} className="object-contain"/>
        </div>
        <div className="z-50 top-1/4  right-0 px-6 lg:pr-12 absolute space-y-3 lg:w-[60%]  items-center lg:items-start w-full flex flex-col gap-3">
      ...
      <div className="w-full relative">
        ...
        <div className=" top-1/4 lg:left-[2%]  px-6 lg:pr-10 absolute space-y-3 lg:w-[60%]  items-center lg:items-start md:items-center w-full flex flex-col gap-3 text-white">

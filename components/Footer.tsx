...
const Footer = () => {
  return (
    <footer className="bg-black px-4 md:px-8 lg:px-14 xl:pr-15 xl:pl-8 py-10 text-white">
      <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-8 relative">
        {/* Logo + Description */}
        ...
        <div className="sm:hidden flex  gap-3 mt-2 items-start">
            <Link href="/"><Facebook className="w-7 h-7 hover:text-red-500" /></Link>
            <Link href="/"><Instagram className="w-7 h-7 hover:text-red-500" /></Link>
            <Link href="/"><Twitter className="w-7 h-7 hover:text-red-500" /></Link>
            <Link href="/"><Youtube className="w-7 h-7 hover:text-red-500" /></Link>
          </div>
        {/* Quick Links */}
        ...
        <div className="hidden md:flex xl:hidden  gap-3 mt-2 items-start">
            <Link href="/"><Facebook className="w-7 h-7 hover:text-red-500" /></Link>
            <Link href="/"><Instagram className="w-7 h-7 hover:text-red-500" /></Link>
            <Link href="/"><Twitter className="w-7 h-7 hover:text-red-500" /></Link>
            <Link href="/"><Youtube className="w-7 h-7 hover:text-red-500" /></Link>
        ...
        <div className="flex flex-col gap-4 items-start">
          ...
          <div className="xl:flex hidden gap-3 mt-2 items-start">
